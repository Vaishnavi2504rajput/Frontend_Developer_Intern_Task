...
## Project Structure:
Frontend_developer_intern_task/
├── frontend/
│ ├── src/
│ ├── public/
│ └── package.json
...
#Scalability Notes:
-Frontend and backend are decoupled using REST APIs.
-JWT authentication allows horizontal backend scaling.
-Modular architecture supports easy feature expansion.
-Ready for deployment using Docker and cloud platforms.
